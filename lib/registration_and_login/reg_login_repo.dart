...
class RegistrationLoginRepo extends ChangeNotifier{

  RegistrationLoginRepo.instance();
  ...
  showSnackBar(BuildContext context,String message){
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(message,style: TextStyle(fontSize: 20),),backgroundColor: ThemeColor.secondary,));
  }
